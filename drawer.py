...
def draw_cell_on(surface: pygame.Surface, x: int, y: int, color=CELL_COLOR) -> None:
...
def draw_cell(x, y, screen: pygame.surface.Surface, color=CELL_COLOR, size: int = 5) -> None:
